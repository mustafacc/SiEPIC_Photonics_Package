...
Example:    Application of SiEPIC_PP calibration with envelope function
"""
...
[power_corrected,power_calib_fit] = SiEPIC_PP.core.calibrate_envelope( input_response, ref_response )
...
fig2 = matplotlib.pyplot.plot(wavelength,power_calib_fit, label='Reference data envelope', color='black')
...
matplotlib.pyplot.savefig(file_name_ref+'_calibrated.pdf')
matplotlib.rcParams.update({'font.size': 14, 'font.family' : 'Times New Roman', 'font.weight': 'bold'})
